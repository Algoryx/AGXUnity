...
namespace AGXUnityEditor.Windows
{
  ...
  public static class ExamplesManager
  {
    ...
    private static string s_metadataURL = @$"https://us.download.algoryx.se/AGXUnity/examples/{PackageManifest.Instance.GetAGXUnityVersionInfo().VersionStringShort}/ExampleMetadata.json";
